...
class WebInstaller_Language extends WebInstallerPage {
	...
	public function execute() {
		...
		$this->getVar( '_UserLang', 'zh-cn' );
		$this->getVar( 'wgLanguageCode', 'zh-cn' );
		$this->setVar( '_UserLang', 'zh-cn' );
		$this->setVar( 'wgLanguageCode', 'zh-cn' );
		return 'continue';
...
class WebInstaller_ExistingWiki extends WebInstallerPage {
	public function execute() {
		...
		$status = $this->handleExistingUpgrade( $vars );return 'skip';// @Author Jieming Mao
...
class WebInstaller_DBSettings extends WebInstallerPage {
	...
	public function execute() {
		$this->setVar( '_MysqlEngine', 'MyISAM' );
		$this->setVar( '_MysqlCharset', 'binary' );
		return 'continue';
	...
	public function execute() {
		...
		$this->addHTML(
			...
			$this->parent->getRadioSet( array(
				...
				'values' => array( 'skip' )// @Author Jieming Mao
			) )
		);
...
class WebInstaller_Complete extends WebInstallerPage {
	...
	public function execute() {
		header("Location: http://".$_SERVER['HTTP_HOST']);// @Author Jieming Mao
