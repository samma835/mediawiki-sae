...
abstract class Installer {
	...
	protected $internalDefaults = array(
		...
		'_SkipOptional' => 'skip',// @Author Jieming Mao
		'_RightsProfile' => 'wiki',
		'_LicenseCode' => 'none',
		'_CCDone' => false,
		'_Extensions' => array(),
	...
	public function findExtensions() {
		...
		while ( ( $file = readdir( $dh ) ) !== false ) {
			...
			if( is_dir("$dir/$file") && file_exists( "$dir/$file/$file.php" ) ) {// @Author Jieming Mao
				$exts[] = $file;
			}
		}
	...
	protected function getInstallSteps( DatabaseInstaller $installer ) {
		$coreInstallSteps = array(
			...
			//array( 'name' => 'keys',       'callback' => array( $this, 'generateKeys' ) ),// @Author Jieming Mao
